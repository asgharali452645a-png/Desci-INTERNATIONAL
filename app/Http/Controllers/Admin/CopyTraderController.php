...
class CopyTraderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('profile_picture')) {
            $profilePicturePath = $request->file('profile_picture')->store('copy-traders', 'public');
        }
        ...
        $copyTrader->profile_picture = $profilePicturePath;
    ...
    public function update(Request $request, CopyTrader $copyTrader): RedirectResponse
    {
        ...
        if ($request->hasFile('profile_picture')) {
            ...
            if ($copyTrader->profile_picture) {
                Storage::disk('public')->delete($copyTrader->profile_picture);
            }

            $newProfilePath = $request->file('profile_picture')->store('copy-traders', 'public');
            $copyTrader->profile_picture = $newProfilePath;
        }
