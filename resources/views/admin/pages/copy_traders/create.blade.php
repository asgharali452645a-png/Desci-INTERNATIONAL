...
<div class="w-full overflow-x-hidden custom-scrollbar">
    <div class="content-area page-transition m-4 md:m-6">
        <div class="p-4 md:p-6 bg-crypto-accent rounded-xl text-white">
            ...
            <form action="{{ route('copy-traders.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="w-full p-2.5 rounded-lg bg-zinc-800 text-sm text-white focus:ring-crypto-primary focus:border-crypto-primary"
                    >
