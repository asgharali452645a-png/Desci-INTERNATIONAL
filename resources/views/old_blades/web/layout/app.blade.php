...
<body class="bg-black dark" @hasSection('sidebar') x-data="{
    sidebarCollapsed: false,
    mobileExpanded: false,
}" @endif>
    <!-- Header with highest z-index -->
    <header class="fixed top-0 left-0 right-0 z-50 bg-crypto-accent dark:border-gray-700">
        <nav>
                        ...
                        @auth('web')
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" @click.away="open = false" x-transition
                                    class="absolute -right-10 mt-2 w-80 bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg shadow-lg z-50">
                ...
                <div class="hidden xl:flex items-center space-x-3 ml-auto">
                    ...
                    @auth('web')
                        ...
                        <a href="{{ route('deposit') }}"
                            class="bg-crypto-primary text-black font-normal px-3 py-1 rounded hover:bg-crypto-primary/80 transition">Deposit</a>
                        <div class="relative group">
                            <button class="flex items-center focus:outline-none">
                                <i class="fas fa-user text-white hover:text-crypto-primary text-lg"></i>
                                <svg class="w-3 h-3 ml-1 text-white group-hover:text-crypto-primary" fill="none"
    ...
    <div class="flex min-h-screen pt-16">
        ...
        @else
        @endif" @hasSection('sidebar') :class="sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-72'" @endif>
            <div>
                @yield('content')
            </div>
        </main>
    ...
    {{-- Loader --}}
    {{-- <div
        class="absolute w-full h-screen start-0 top-0 flex bg-crypto-accent/40 items-center justify-center z-[999]"
        id="loader">
    ...
    :class="sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-72'" @endif>
    ...
    show = true; message = '{{ session('info') }}'; type = 'info'; @endif
        ...
        <div x-show="type === 'error'"
            class="flex items-center w-full max-w-xs p-4 mb-4 text-red-800 bg-red-100 rounded-lg shadow" role="alert">
        ...
        <div x-show="type === 'info'"
            class="flex items-center w-full max-w-xs p-4 mb-4 text-blue-800 bg-blue-100 rounded-lg shadow" role="alert">
