        ...
        <div class="content-area page-transition mt-20 md:mt-0">
            <div class="p-4 md:p-6 mt-10">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-bold text-white mb-2">My Account</h2>
                        <p class="text-gray-400">View and update your profile information.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="mb-6">
                        <i class="fas fa-user-circle text-6xl text-crypto-primary opacity-50"></i>
                    </div>
                    <h3 class="text-xl font-medium text-white mb-2">Account Management</h3>
                    <p class="text-gray-400 text-center max-w-md">
                        Your account profile and verification status will be managed here. We're currently building these
                        features.
                    </p>
