...
@section('content')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    <div class="grid grid-cols-2 gap-3">
                        <!-- Top Row -->
                        <div
                            class="bg-gradient-to-br from-crypto-primary via-yellow-500 to-orange-500 rounded-xl p-4 text-black relative overflow-hidden">
                            <div class="absolute top-2 left-2 bg-black/20 text-xs px-2 py-1 rounded text-white">Sponsored
                            </div>
                            <div class="mt-6">
                        ...
                        <div class="bg-binance-card rounded-xl p-4 border border-gray-700 relative">
                            ...
                            <div
                                class="absolute top-2 right-2 w-6 h-6 bg-crypto-primary rounded text-black text-xs flex items-center justify-center font-bold">
                                !</div>
                        </div>
                        ...
                        <div
                            class="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-xl p-4 text-white relative overflow-hidden">
                            ...
                            <div class="absolute -right-2 -bottom-2 w-12 h-12 bg-white/10 rounded-lg transform rotate-12">
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-crypto-primary to-orange-500 rounded-lg transform rotate-12 opacity-80 flex items-center justify-center">
    ...
    <section class="bg-binance-dark py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Tabs -->
            <div class="mb-6">
                <ul class="flex flex-wrap text-sm font-medium text-center text-gray-400 border-b border-gray-700"
                    id="nft-tabs" data-tabs-toggle="#nft-tab-content" role="tablist">
                    <li class="me-8" role="presentation">
                        <button
                            class="inline-block pb-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-300 hover:border-gray-600 text-gray-400"
                            id="trending-tab" data-tabs-target="#trending" type="button" role="tab" aria-controls="trending"
                            aria-selected="false">
                            Trending
                        </button>
                    </li>
                    <li class="me-8" role="presentation">
                        <button
                            class="inline-block pb-4 text-crypto-primary border-b-2 border-crypto-primary rounded-t-lg active font-medium"
                            id="top-tab" data-tabs-target="#top" type="button" role="tab" aria-controls="top"
                            aria-selected="true">
                            Top
                        </button>
                    </li>
                ...
                <div class="" id="top" role="tabpanel" aria-labelledby="top-tab">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <!-- Left Column - Rank 1 -->
                            <div
                                class="flex items-center py-3 px-4 relative hover:bg-crypto-accent/70 cursor-pointer rounded-lg duration-200 hover:scale-105">
                                <div class="w-8 text-gray-400 text-sm">1</div>
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center relative">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center relative">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🐱</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center relative">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center relative">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-blue-500 to-teal-500 rounded-full flex items-center justify-center relative">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center relative">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-teal-500 to-blue-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">⚡</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-gray-600 to-gray-800 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🌍</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🎄</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🎮</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center relative">
                        ...
                        <div class="grid grid-cols-2 gap-8 hover:bg-binance-gray/30 rounded-lg transition-colors">
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-red-500 to-orange-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🍔</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex items-center py-3 px-4">
                                ...
                                <div class="flex items-center space-x-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-yellow-500 to-red-500 rounded-full flex items-center justify-center relative">
                                        <span class="text-white font-bold text-sm">🅱️</span>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center">
                                            <svg class="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="text-center mt-8">
                        <button
                            class="bg-binance-card hover:bg-binance-light-gray text-white px-8 py-3 rounded-lg transition-colors border border-gray-700 hover:border-gray-600">
                            View All
                        </button>
                    </div>
                </div>
    ...
    <section class="bg-binance-dark py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div
                    class="bg-binance-card rounded-lg overflow-hidden border border-gray-700 hover:border-crypto-primary/50 transition-colors group">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between text-sm mt-1">
                            <span class="text-gray-400">Floor Price: <span class="text-white font-medium">178.64
                                    USD</span></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-transparent text-white"
                ...
                <h2 id="accordion-flush-heading-1">
                    <button type="button"
                        class="flex items-center justify-between w-full py-4 font-medium text-left text-white border-b border-gray-700 hover:text-crypto-primary transition-colors duration-200"
                        data-accordion-target="#accordion-flush-body-1" aria-expanded="false"
                        aria-controls="accordion-flush-body-1">
                        <span class="text-sm">How to Find NFTs on Binance NFT Marketplace</span>
                        <svg data-accordion-icon class="w-5 h-5 shrink-0 text-gray-400" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                ...
                <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                    <div class="py-4 border-b border-gray-700">
                        <p class="text-gray-300 text-sm">Browse collections, use search, or explore trending sections to
                            find NFTs on Binance NFT Marketplace.</p>
                    </div>
                </div>
                ...
                <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                    <div class="py-4 border-b border-gray-700">
                        <p class="text-gray-300 text-sm">Select an NFT, review details, and complete purchase using your
                            Binance account balance or supported cryptocurrencies.</p>
                    </div>
                </div>
                ...
                <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                    <div class="py-4 border-b border-gray-700">
                        <p class="text-gray-300 text-sm">Go to your profile, select the NFT, set your price, and list it on
                            the marketplace.</p>
                    </div>
                </div>
                ...
                <div id="accordion-flush-body-4" class="hidden" aria-labelledby="accordion-flush-heading-4">
                    <div class="py-4 border-b border-gray-700">
                        <p class="text-gray-300 text-sm">Deposit NFTs from external wallets through the deposit function in
                            your profile.</p>
                    </div>
                </div>
                ...
                <div id="accordion-flush-body-5" class="hidden" aria-labelledby="accordion-flush-heading-5">
                    <div class="py-4 border-b border-gray-700">
                        <p class="text-gray-300 text-sm">Desci NFT charges competitive trading fees for NFT transactions
